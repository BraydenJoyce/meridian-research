...
import { AlertCircle, CheckCircle, Loader2, Search, ShieldCheck, Zap } from "lucide-react";
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h2 className="text-3xl font-bold text-white tracking-tight leading-snug">
              Intelligence that works as fast as you do
            </h2>
            <p className="text-white/45 mt-2 text-sm leading-relaxed">
              3 free research reports included. No credit card required.
            </p>
          </div>
          ...
          {success ? (
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-400 mt-1">Start with 3 free intelligence reports</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    required aria-label="Password" minLength={8}
                    className="w-full border-b-2 border-slate-200 focus:border-indigo-500 bg-transparent px-0 py-2 text-[15px] text-slate-900 placeholder:text-slate-300 outline-none transition-colors"
                  />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="confirm-password" className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Confirm password</label>
                  <input
